        ...
        <ScrollTriggeredAnimation>
          <div className="flex flex-col md:flex-row justify-center gap-10">
            ...
            <Card
              ...
              cardElements={
                <div>
                  <Checks paragraphs="Veridaq Reference" />
                  <Checks paragraphs="Document Verification Veridaq" />
                </div>
              }
            />
          </div>
        ...
        <ScrollTriggeredAnimation>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-10">
            ...
            <Card
              ...
              cardElements={
                <div>
                  <Checks paragraphs="Veridaq Reference (available for users in Nigeria)" />
                  <p className="font-semibold text-[20px] text-center mb-5">
                    Price N5,000
                  </p>
                  <Checks paragraphs="Document Verification Reference" />
                  <p className="font-semibold text-[20px] text-center mb-5">
                    Document Verification Reference: Fee = Issuing Organisation
                    charge + 50% Markup
                  </p>
                </div>
              }
