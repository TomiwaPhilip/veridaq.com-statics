...
export default function TermsAndConditions(){
  return (
    <div className="mx-[50px] mt-[150px] pt-[10]">
      ...
      <p className="text-white mb-4">
        b. <strong>Verifiable Claim:</strong> This digital representation validates claims, statuses, and data issued to users. It includes metadata and supporting evidence.
      </p>
      <p className="text-white mb-4">
        c. <strong>Applicability:</strong> These Terms apply to veridaq.com, Veridaq-branded apps, and related platforms.
      </p>
      <p className="text-white mb-4">
      ...
      <p className="text-white mb-4">
        b. <strong>Unauthorized Access:</strong> Developing, supporting, or using software, devices, scripts, or any other means to scrape or copy profiles and data from the services without authorization.
      </p>
      <p className="text-white mb-4">
        c. <strong>Security Override:</strong> Attempting to override or circumvent any security feature, access control, or usage limit of the service.
      </p>
      <p className="text-white mb-4">
        d. <strong>Unauthorized Use of Information:</strong> Copying, using, disclosing, or distributing any information obtained from the services without consent.
      </p>
      <p className="text-white mb-4">
        e. <strong>Unauthorized Disclosure:</strong> Disclosing information that you do not have consent to disclose, such as confidential information of others.
      </p>
      <p className="text-white mb-4">
        f. <strong>Violation of Intellectual Property Rights:</strong> Violating the intellectual property rights of others, including copyrights, patents, trademarks, trade secrets, or other proprietary rights.
      </p>
      <p className="text-white mb-4">
        g. <strong>Violation of Veridaq's Rights:</strong> Violating Veridaq's intellectual property rights, including unauthorized use of trademarks, logos, or technology.
      </p>
      <p className="text-white mb-4">
        h. <strong>Malicious Content:</strong> Posting anything on the services that contains harmful code such as viruses or worms.
      </p>
      <p className="text-white mb-4">
        i. <strong>Reverse Engineering:</strong> Attempting to reverse engineer, decompile, disassemble, or decipher the source code of the services.
      </p>
      <p className="text-white mb-4">
        j. <strong>False Affiliation:</strong> Implying or stating affiliation with Veridaq without written consent.
      </p>
      <p className="text-white mb-4">
        k. <strong>Unauthorized Monetization:</strong> Renting, leasing, trading, selling, or otherwise monetizing the services or related data without consent.
      </p>
      <p className="text-white mb-4">
        l. <strong>Unauthorized Linking:</strong> Deep-linking to the services for any purpose other than promoting your profile without consent.
      </p>
      <p className="text-white mb-4">
        m. <strong>Automated Access:</strong> Using bots or automated methods to access the services, add contacts, or send messages.
      </p>
      <p className="text-white mb-4">
        n. <strong>Competitive Monitoring:</strong> Monitoring the availability, performance, or functionality of the services for competitive purposes.
      </p>
      <p className="text-white mb-4">
        o. <strong>Misrepresentation:</strong> Engaging in framing, mirroring, or simulating the appearance or function of the services.
      </p>
      <p className="text-white mb-4">
        p. <strong>Interference:</strong> Interfering with the operation of the services or placing an unreasonable load on them, such as spamming or launching denial of service attacks.
      </p>
      <p className="text-white mb-4">
        q. <strong>Source Code Access:</strong> Attempting to access or derive the source code or architecture of the services.
      </p>
      <p className="text-white mb-4">
        r. <strong>Impersonation:</strong> Impersonating Veridaq, a Veridaq employee, another user, or any other person or entity.
      </p>
      <p className="text-white mb-4">
