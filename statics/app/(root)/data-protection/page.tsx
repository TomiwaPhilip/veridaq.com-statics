...
export default function DataProtectionPolicy(){
  return (
    <div className="mx-[50px] mt-[150px] pt-[10]">
      <h2 className="text-2xl text-white mb-4 font-bold">Data Protection Policy</h2>
      ...
      <h4 className="text-lg text-white mb-2 font-bold">2. Purpose of the Policy</h4>
      <p className="text-white mb-4">
      ...
      <h4 className="text-lg text-white mb-2 font-bold">3. Roles and Responsibilities</h4>
      <p className="text-white mb-4">
      ...
      <h4 className="text-lg text-white mb-2 font-bold">4. Data Protection and Governing Principles</h4>
      <p className="text-white mb-4">
      ...
      <h4 className="text-lg text-white mb-2 font-bold">5. Information Security Measures</h4>
      <p className="text-white mb-4">
      ...
      <h4 className="text-lg text-white mb-2 font-bold">6. Legal Requirements and Regulations</h4>
      <p className="text-white mb-4">
